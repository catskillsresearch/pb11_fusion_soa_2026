...
| **C — Confinement class** | MCF (ST, FRC, helical, open-field mirror), ICF / HEDP, magneto-inertial / DPF, or hybrid? (§4) |
...
*   **K — Kinetics / Rider:** Picosecond CPA lasers; ponderomotive block acceleration produces directed beams faster than ion–electron thermalization, suppressing thermal Bremsstrahlung [2].
*   **R — Radiation:** Nonthermal burn minimizes steady Bremsstrahlung; transient X-ray flash handled by carbon-composite / WC armor against cyclic shock.
...
*   **L — Lawson / $Q$:** Gain sought via nonthermal burn propagation (kinetic/rad-hydro models with Rochester TriForce) [7]; plant $Q$ still contingent on driver efficiency and rep-rate (Xie’s ICF zeroth-order caveat [40]).
*   **C — Confinement:** Laser ICF / block ignition (pulsed).
*   **M — Materials & capture:** Double-walled He-cooled spherical chamber at 10–20 Hz. Megavolt spherical electrostatic grid decelerates $\sim 2.9$ MeV alphas. Unobtainium: vacuum insulation under ionizing debris; final-optics survival at high rep-rate.
...
Table 1 scores principal $p\text{-}^{11}\text{B}$ (and closely related) paths on the §1.2 zeroth-order gates. Sister advanced-fuel rows (Helion, PFS) are included for contrast after §4.1. Legend: **●** = publicly articulated strategy with supporting hardware, peer-reviewed analysis, or formal design review; **◐** = partial / roadmap-level / component-only; **○** = weak, absent, or not yet public; **—** = not applicable. Scores are editorial judgments for comparison, not certifications.
...
| **HB11** [2,7] | Laser ICF | ● | ● | ● | ◐ | ◐ | ◐ | ◐ | ◐ | ◐ | Block ignition + DEC grid; driver/rep-rate **L**/**M** risk. |
...
| **Avalanche Energy** [66] | Orbitron (MEC) | — | — | — | — | ◐ | ◐ | ◐ | ● | ● | Not $p\text{-}^{11}\text{B}$; archetype of high **H** (+ open WarpX/OpenMC **S**); §8. |
...
Two poles illustrate the trade. **Pale Blue / CHARM** and related theory houses explicitly prioritize an *in-silico power-positive* reactor before major hardware [33]—high **S**, low **H** so far. **Avalanche Energy** (Orbitron magneto-electrostatic machines; not a $p\text{-}^{11}\text{B}$ electricity play) markets rapid design–build–test–learn on desk-sized devices, while also running open PIC/neutronics stacks (WarpX, OpenMC) on multi-cloud HPC [66,67]—high **H**, nontrivial **S**. Neither pole alone closes gates **L** and **M**.
...
66. **Avalanche Energy.** Company materials on rapid design–build–test–learn for compact Orbitron machines; FusionWERX / neutron-factory announcements. https://www.avalanchefusion.com/
