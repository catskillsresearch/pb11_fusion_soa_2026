...
| **TAE Technologies** | Quasi-steady | Beam-driven FRC | $p\text{-}^{11}\text{B}$ | Deepest private FRC capital; Rostoker→Norman→Da Vinci lineage; LHD alphas |
...
*   **T — T2M:** Multi-generation devices (Norman/C-2W → Norm); 2025 NBI-only formation on shortened Norm [36]; company claims Copernicus skip toward Da Vinci [37]; deepest private $p\text{-}^{11}\text{B}$ capital and patent portfolio in this survey (§10)—already $>$\$600\,\mathrm{M} raised by the 2020 profile, with further raises since [58,59,89].
