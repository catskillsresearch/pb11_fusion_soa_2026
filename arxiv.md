...
| :--- | :--- | :--- | :--- |
| **ENN Energy Research Institute** [6,12,22] | China | Spherical Torus (Magnetic) | Dual HEDP + ST strategy; EXL-50U H–B plasmas and ICRF+NBI $p\text{-}^{11}\text{B}$ campaigns; EHL-2 design ($Q>10$ roadmap $\sim 2035$); nuclear-data, spin-polarization, and non-Maxwellian theory program [12]. |
